    ...
    public AndroidClientSocket(String ip, int port) {
        ...
        socket = new WebSocketClient(URI.create("wss://"
            ...
            public void onOpen(ServerHandshake handshakedata) {
                notifyOpen(AndroidClientSocket.this);
            }
            ...
            public void onMessage(String message) {
                ...
                notifyMessage(AndroidClientSocket.this, packet);
            }

            @Override
            public void onClose(int code, String reason, boolean remote) {
                notifyClose(AndroidClientSocket.this);
            }

            @Override
            public void onError(Exception ex) {
                notifyException(AndroidClientSocket.this, ex);
            }
        };
    }
